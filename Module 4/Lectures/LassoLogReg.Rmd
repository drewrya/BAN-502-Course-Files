...
Objective: Estimate probability a team wins if matched-up with any other team in the 2022 Men's NCAA Basketball tournament.
The competition is described here: https://www.kaggle.com/competitions/mens-march-mania-2022/data.
...
#### Read-In Data
```{r}
results = read_csv("NCAAcleaned.csv")
