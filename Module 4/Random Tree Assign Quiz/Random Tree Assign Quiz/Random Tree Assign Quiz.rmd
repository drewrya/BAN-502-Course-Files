...
Visualization  
```{r}
p5 = ggplot(train, aes(x = Cscore, fill = Nicotine)) + geom_bar(position = "fill")
p6 = ggplot(train, aes(x = Nscore, fill = Nicotine)) + geom_bar(position = "fill")
p7 = ggplot(train, aes(x = Oscore, fill = Nicotine)) + geom_bar(position = "fill")
p8 = ggplot(train, aes(x = Ascore, fill = Nicotine)) + geom_bar(position = "fill")
grid.arrange(p5,p6,p7,p8)
```

Visualization  
```{r}
p9 = ggplot(train, aes(x = Escore, fill = Nicotine)) + geom_bar(position = "fill")
p10 = ggplot(train, aes(x = Impulsive, fill = Nicotine)) + geom_bar(position = "fill")
p11 = ggplot(train, aes(x = SS, fill = Nicotine)) + geom_bar(position = "fill")
p12 = ggplot(train, aes(x = , fill = Nicotine)) + geom_bar(position = "fill")
